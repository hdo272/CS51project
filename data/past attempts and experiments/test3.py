...
#cv2.imwrite('td.png', td)


# Next steps:
# Put the result through OCR? That would be really cool.
# Put these functionalities into classes! Organize.
# ---> Use fancy design patterns.
